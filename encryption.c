...
{
    printf("Shift Rows called\n");

    // We can even do it statically, because index positions will always be constant and improve performance.
...
void addRoundKey(unsigned char block[16], unsigned char key[16])
{
    printf("Add Round Key called\n");
    for (int i = 0; i < 16; i++)
    {
